      ...
      <div className="space-y-12">
        ...
        <section className="pt-spacing-gap-lg border-t border-border-subtle">
          <div className="flex items-center justify-between">
            ...
            <button type="button" className="px-4 py-2 border border-error text-error hover:bg-error-container/10 transition-colors text-label-md">Revoke Access</button>
          </div>
        </section>
      </div>
    </SidebarLayout>
