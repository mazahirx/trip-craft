      ...
      <section className="py-32">
        <div className="max-w-max-width-content mx-auto px-spacing-margin-mobile md:px-spacing-margin-page">
          <div className="max-w-2xl">
            <span className="text-label-md text-text-secondary tracking-widest uppercase mb-spacing-gap-sm block">
              Our Philosophy
            </span>
            ...
            <p className="text-body-lg text-text-secondary leading-relaxed mb-spacing-gap-lg">
              We stripped away the clutter of modern travel apps—no ads, no tracking, and $0 infrastructure dependencies for the core user experience. Our focus is pure utility: a blank canvas for your itineraries that stays out of your way until you need it.
            </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-12">
            <div className="flex flex-col gap-spacing-gap-sm">
              ...
              <p className="text-body-md text-text-secondary max-w-xs">
                The minimal travel planner for organized explorers. Built with precision for the modern nomad.
              </p>
            </div>
            ...
            <div className="w-full md:w-auto">
              <Link
                href="/trips/new"
                className="block w-full md:w-auto bg-primary text-on-primary px-spacing-gap-lg py-spacing-gap-sm rounded-lg text-label-md hover:opacity-90 transition-soft text-center"
              >
                Launch App
              </Link>
            </div>
