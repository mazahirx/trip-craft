  ...
  return (
    <AppShell>
      <section className="max-w-max-width-content mx-auto px-spacing-margin-mobile md:px-spacing-margin-page pt-32 pb-spacing-gap-lg text-center md:text-left">
        <div className="flex flex-col gap-3 gap-spacing-gap-md mb-24">
          ...
          <div className="flex flex-col sm:flex-row gap-4 gap-spacing-gap-sm mt-spacing-gap-md justify-center md:justify-start">
            <Link
              href="/trips/new"
            ...
            <Link 
              href="#features"
              className="bg-bg-canvas border border-zinc-600 text-primary px-10 py-4 rounded-lg text-headline-md hover:bg-hover-fill transition-soft text-center"
            >
              View Demo
            </Link>
          </div>
      ...
      <section id="features" className="bg-surface py-32 border-y border-border-subtle">
        <div className="max-w-max-width-content mx-auto px-spacing-margin-mobile md:px-spacing-margin-page">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="flex flex-col gap-0.5 gap-spacing-gap-sm">
      ...
      <section className="py-32">
        <div className="max-w-max-width-content mx-auto px-spacing-margin-mobile md:px-spacing-margin-page">
          <div className="max-w-2xl">
            <span className="text-label-md text-text-secondary tracking-widest uppercase mb-spacing-gap-sm block">Why I built this?</span>
            <h2 className="text-headline-lg text-primary my-1 mb-spacing-gap-md">
              TripCraft is built on the belief that planning should be as enjoyable as the journey itself.
            </h2>
            <p className="text-body-lg text-text-secondary my-3 leading-relaxed mb-spacing-gap-lg">
            ...
            <div className="pl-spacing-gap-lg relative">
              <div className="mb-spacing-gap-md py-2">
        ...
        <div className="max-w-max-width-content mx-auto px-spacing-margin-mobile md:px-spacing-margin-page">
          <div className="flex flex-col md:flex-row justify-between items-start gap-12">
            ...
            <div className="grid grid-cols-2 gap-12 sm:gap-24">
              <div className="flex flex-col gap-0.5 gap-spacing-base">
            ...
            <div className="w-full md:w-auto">
              <Link href="/trips/new" className="block w-full md:w-auto bg-primary text-on-primary px-spacing-gap-lg px-3 py-2 py-spacing-gap-sm rounded-lg text-label-md hover:opacity-90 transition-soft text-center">
                Launch App
              </Link>
            </div>
          </div>
