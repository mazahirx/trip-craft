  ...
  return (
    <div className="auth-card flex flex-col items-center w-full max-w-sm mx-auto">
      ...
      <div className="w-full flex items-center gap-spacing-gap-md mb-spacing-gap-lg">
        ...
        <span className="text-label-md text-on-surface-variant uppercase tracking-widest">or</span>
        <div className="h-px flex-grow bg-border-subtle" />
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="w-full space-y-spacing-gap-md">
        <div className="space-y-spacing-base">
          <label className="text-label-md text-text-secondary ml-spacing-base" htmlFor="email">
            Email
          </label>
          <input
            id="email"
        ...
        <div className="space-y-spacing-base">
          <div className="flex justify-between items-center px-spacing-base">
            <label className="text-label-md text-text-secondary" htmlFor="password">
              Password
            </label>
          </div>
          <input
