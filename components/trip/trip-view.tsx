...
export function TripView({ tripId }: { tripId: string }) {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-20">
        <span className="text-body-md text-text-secondary">Loading trip…</span>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="rounded-lg border border-error-container/50 bg-error-container/10 p-6 text-center">
