            ...
            <div className="flex justify-between items-start mb-2 gap-2">
              ...
              <div className="flex gap-2 shrink-0">
                ...
                <button
                  ...
                  className="text-label-md text-text-secondary hover:text-error transition-colors"
                >
                  Remove
                </button>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-spacing-gap-md mt-4">
              ...
              <div className="p-4 border border-border-subtle rounded-lg hover:border-border-muted transition-colors bg-surface-container-lowest">
                ...
                <p className="text-body-md text-text-secondary italic">
                  {cp.stays?.length ? cp.stays[0].name : "No lodging set"}
                </p>
              </div>
              {/* Notes */}
              <div className="p-4 border border-border-subtle rounded-lg hover:border-border-muted transition-colors bg-surface-container-lowest">
                ...
                <p className="text-body-md text-text-secondary leading-relaxed">
                  {cp.notes || "No notes for this stop."}
                </p>
              </div>
            </div>
          </div>
          ...
          {showForm ? (
            <div className="flex gap-2 items-center">
              ...
              <button
                type="button"
                onClick={handleAdd}
                className="text-label-md text-primary font-medium hover:opacity-80"
              >
                Add
              </button>
              <button
                type="button"
                onClick={() => { setShowForm(false); setNewLocation(""); }}
                className="text-label-md text-text-secondary hover:text-primary"
              >
                Cancel
              </button>
            </div>
            ...
            <button
              type="button"
              onClick={() => setShowForm(true)}
              className="text-text-secondary text-body-md hover:text-primary transition-colors flex items-center gap-2"
            >
